...
class Command(BaseCommand):
    help = "Pobla el curso Segundo B con 20 alumnos para la gestión 1-2024."
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS(f"🎉 Se crearon {total} alumnos para Segundo B en gestión 1-2024."))
