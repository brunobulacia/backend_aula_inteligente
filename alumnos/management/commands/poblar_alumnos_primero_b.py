...
class Command(BaseCommand):
    help = "Pobla el curso Primero B con 20 alumnos para la gestión 1-2024."
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS(f"🎉 Se crearon {total} alumnos para Primero B en gestión 1-2024."))
