...
class Command(BaseCommand):
    help = "Pobla la gestión 1-2024 para todos los alumnos del curso Segundo A"
    ...
    def handle(self, *args, **kwargs):
        ...
        if not asignaciones.exists():
            self.stdout.write(self.style.WARNING("⚠️ No hay materias asignadas para Segundo A en 1-2024"))
            return

        # Solo alumnos de Segundo A (id 61 al 80)
        ...
        self.stdout.write(self.style.SUCCESS(f"✅ Gestión 1-2024 poblada para {total} alumno(s) de Segundo A."))
